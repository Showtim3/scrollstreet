            ...
            <Container>
                ...
                <ReturnPolicyText><span>Once we receive the returned products, a quality check will be performed on the items by our quality team. This is subject to the return having met the following requirements:</span>
                    <ul>
                        ...
                        <li>The product should have the original packaging and tags in place. Items without the original
                            tags will not be accepted.
                        </li>
                        <li>They should have been returned within 48 hours from the delivery time.</li>
                        <li>They should have been returned within 48 hours from the delivery time.</li>
                        <li>In case you receive a damaged/defective product, we may request you to share snapshot at
                            contact@xoxoprotection.com.
                        </li>
                        <li>To return your product, you should mail at contact@xoxoprotection.com for the return
                            address.
                        </li>
                    </ul>
                </ReturnPolicyText>
